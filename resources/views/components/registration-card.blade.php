<div class="bg-white rounded-3xl shadow-xl flex flex-col">
    <div class=" text-black flex gap-4 text-center w-full bg-gray-300 rounded-full overflow-hidden">
        ...
        @else
            <div
                class="{{ url()->current() === 'http://127.0.0.1:8000' ? 'bg-blue-800 text-white' : '' }} rounded-r-full w-full flex p-2 gap-2">
                <div class="bg-white text-black font-medium w-6 rounded-full p-1 text-xs ">1</div>
                <p>Personal</p>
            </div>
            <div
                class="{{ url()->current() === 'http://127.0.0.1:8000/registers2' ? 'bg-blue-800 text-white' : '' }} rounded-full flex p-2 gap-2 w-full">
                <div class="bg-white text-black w-6 rounded-full p-1 text-xs ">2</div>
                <p>Contact</p>
            </div>
            <div
                class="{{ url()->current() === 'http://127.0.0.1:8000/registers3' ? 'bg-blue-800 text-white' : '' }} rounded-full flex p-2 gap-2 w-full">
                <div class="bg-white text-black w-6 rounded-full p-1 text-xs ">3</div>
                <p>Address</p>
            </div>
            <div
                class="{{ url()->current() === 'http://127.0.0.1:8000/registers4' ? 'bg-blue-800 text-white' : '' }} rounded-full flex p-2 gap-2 w-full">
                <div class="bg-white text-black w-6 rounded-full p-1 text-xs ">4</div>
                <p>Emergency</p>
            </div>
            <div
                class="{{ url()->current() === 'http://127.0.0.1:8000/registers5' ? 'bg-blue-800 text-white' : '' }} rounded-l-full flex p-2 gap-2 w-full">
                <div class="bg-white text-black w-6 rounded-full p-1 text-xs ">5</div>
                <p>Document</p>
            </div>
        @endif
