...
<body class="antialiased">
    ...
    <script>
        ...
        function clickMe() {
            if (drpElement.classList.contains("invisible", "hidden")) {
                drpElement.classList.remove("invisible", "hidden")
                drpElement.classList.add("visible", "block")
            } else {
                drpElement.classList.remove("visible", "block")
                drpElement.classList.add("invisible", "hidden")
            }
        }
    </script>
</body>
