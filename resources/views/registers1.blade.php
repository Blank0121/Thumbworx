...
<body>
    ...
    <div
        ...
        <form action="/registers2" class=" flex-col flex gap-4 w-full signup-form px-10 py-8">
            @csrf
            ...
            <div class="flex row w-full justify-between">
                ...
                <div>
                    ...
                    <x-bladewind.input name="Middle_Name" type="text" required="true" id="Middle_Name" class="rounded-md"
